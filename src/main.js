import './style.css';
const PROFILE = {"day":"Day078","title":"Repair Ladder Builder","display_name_ja":"謝り方なおし段","one_sentence":"謝る相手と起きたことから、先にする行動と送る一言を段にするツール","purpose_line_ja":"謝る前の行動順を決めるためのツールです。","use_case_line_ja":"返信前に謝り方で迷う時に使います。","how_it_works_line_ja":"出来事と行動を入れると、順番が出ます。","core_action":"tone","family":"apology_tone_repair","mechanic":"tone_ladder","input_style":"incident_cards","output_style":"repair_steps","output_label":"ここを見ればOKです","audience_promise":"送る前に、言葉だけで済ませない形へ直せる。","publish_hook":"出来事と相手を入れると、行動の順番と一言がすぐ分かる。","engine":"brief_driven","interaction_archetype":"tone_ladder","page_archetype":"stack_cards","ui_variant":"repair","intro_variant":"repair_ladder","interaction_model":"editable_incidents_to_repair_ladder","primary_layout":"incident_action_editor_with_ladder_preview","result_presentation_style":"repair_steps_and_short_apology_line","palette_motif":"謝り方ラダーグリーン","main_cta":"返信遅れで試す","input_panel_title":"出来事と先にする行動を足す","sample_panel_title":"返信遅れで試す","guide_panel_title":"行動順の見どころ","hero_panel_label":"先にする行動順","output_shape":"stack_cards","state_model":"tone_ladder_state","core_loop":"incident_cards -> tone_ladder -> repair_steps","component_pack":"stack_cards+repair_steps","scaffold_id":"brief_canvas","single_shot_text_generator":false};
